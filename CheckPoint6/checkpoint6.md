...
En programación, **una clase** es como el molde o la receta para crear algo, en este caso que vamos a usar como ejemplo, una factura. Y cada factura que creamos a partir de ese molde es un objeto.
...
- `Los objetos` son las cosas que creamos a partir de la clase.
- `Los métodos` *(funciones dentro de la clase)* permiten que los objetos hagan cosas.
...
- **GET :** Se usa para obtener datos de un servidor. `GET /usuarios ==> obtiene una lista de usuarios`

- **POST :** Para enviar datos a un servidor y crear nuevos recursos. `POST /usuarios ==>  crea un nuevo usuario`

- **DELETE :** Para eliminar recursos en un servidor. `PUT /usuarios/1 ==> actualiza el usuario cuya ID 1`

---

## ¿Es MongoDB una base de datos SQL o NoSQL?

**MongoDB** es una base de datos **NoSQL** porque almacena datos en documentos JSON en lugar de tablas relacionales. Es flexible y escalable, ideal para aplicaciones que requieren manejar grandes volúmenes de datos no estructurados.
